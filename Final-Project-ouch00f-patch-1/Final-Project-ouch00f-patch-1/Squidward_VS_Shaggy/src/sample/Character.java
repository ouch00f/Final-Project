...
public abstract class Character extends HBox {
    //Fields
    protected double speed, jumpConstant;
    ...
    public void standRight(){
        ...
        if(!this.isFalling && differentImage(standingRight) ) {
    ...
    protected boolean differentImage(Image img){
        return !(img == this.currentImage);
    }
